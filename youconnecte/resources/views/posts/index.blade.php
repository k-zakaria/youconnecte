            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item mt-2">
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle" id="notificationsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu dropdown-menu-center  notify-drop" style="width: 30vh;"  aria-labelledby="notificationsDropdown">
                                ...
                                @if($likedByUser)
                                <div class="container">
                                    <div>{{ $message->user->name }} liked a post</div>
                                </div>
                                @endif
                                @endforeach
                            </ul>
