                    ...
                    <div class="card-body">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                @endif
                                <div class="mt-3">
                                    <form action="{{ route('posts.like') }}" method="post" class="d-inline">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$message->id}}">
                                        <button type="submit" class="btn btn-sm btn-primary">{{$message->likes->count()}} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
